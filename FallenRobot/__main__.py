        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", url=f"https://t.me/anime_x_god_group"
                        ),
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/anime_x_god"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            url="https://t.me/Andi_mandi_sandi_tu_hai_randi/13",
                        ),
                    ],
                    [
...
Iғ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ʀᴇᴘᴏ ᴛʜᴇɴ ғɪʀsᴛ Jᴏɪɴ ᴛʜᴇsᴇ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ ɢʀᴏᴜᴘs ᴏᴛʜᴇʀᴡɪsᴇ ʏᴏᴜ ᴡɪʟʟ ɴᴏᴛ ɢᴇᴛ ᴛʜᴇ ʟɪɴᴋ ᴏғ ᴛʜᴇ ʀᴇᴘᴏ.💀 : [Gʀᴏᴜᴘ](https://t.me/anime_x_god_group)
[ᴄʜᴀɴɴᴇʟ](https://t.me/anime_x_god)


*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://t.me/Andi_mandi_sandi_tu_hai_randi/13)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/gauravsahu255/FALLEN/blob/master/LICENSE).
© 2022 - 2023 | [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/ANIME_X_GOD_GROUP), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
